            ...
            <div className="grid items-center w-full gap-4 md:grid-cols-2">
               ...
               <div className="py-6 px-6 lg:px-8 max-md:-order-1">
                  <div className="max-w-md mx-auto w-full">
                     <h1 className="text-slate-900 text-3xl font-bold mb-8 dark:text-slate-50">
                        Sign in
                     </h1>
                     ...
                     <div className="mt-6 text-slate-900 text-sm text-center dark:text-slate-50">Don't have an account? <a href="#"
